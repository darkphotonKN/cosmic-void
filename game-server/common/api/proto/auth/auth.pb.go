...
const file_api_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x19api/proto/auth/auth.proto\x12\x04auth\x1a\x1fgoogle/protobuf/timestamp.proto\"\xaa\x02\n" +
	"\x06Member\x12\x0e\n" +
	...
	"\n" +
	"avatar_url\x18\b \x01(\tR\tavatarUrl\x12\x12\n" +
	...
	"\n" +
	"avatar_url\x18\x03 \x01(\tR\tavatarUrl2\x8d\x06\n" +
	"\vAuthService\x128\n" +
	...
	"\x18UpdateSubscriptionStatus\x12%.auth.UpdateSubscriptionStatusRequest\x1a&.auth.UpdateSubscriptionStatusResponse\"\x00\x12G\n" +
	"\x10CheckEmailExists\x12\x17.auth.CheckEmailRequest\x1a\x18.auth.CheckEmailResponse\"\x002\xc7\x01\n" +
	"\rUploadService\x12Z\n" +
