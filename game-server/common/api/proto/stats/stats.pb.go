...
const file_api_proto_stats_stats_proto_rawDesc = "" +
	...
	"\tmember_id\x18\x01 \x01(\tR\bmemberId\"\xc3\x03\n" +
	...
	"\n" +
	"top_threes\x18\x05 \x01(\x05R\ttopThrees\x12\x1d\n" +
	"\n" +
	"avatar_url\x18\x06 \x01(\tR\tavatarUrl\x12\x16\n" +
	"\x06rating\x18\a \x01(\x05R\x06rating\x12(\n" +
	"\rrank_position\x18\b \x01(\x05H\x00R\frankPosition\x88\x01\x01\x12H\n" +
	"\x12last_calculated_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x10lastCalculatedAt\x129\n" +
	"\n" +
	"created_at\x18\n" +
