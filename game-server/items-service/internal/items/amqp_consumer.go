...
type ConsumerService interface {
	// Add item-related event processing methods here as needed
	// 處理遊戲結束事件，發放道具獎勵
	// ProcessMatchEndedReward(ctx context.Context, matchResult MatchEndedEvent) error
}
...
func SetupAMQPInfrastructure(channel *amqp.Channel) error {
	...
	slog.Info("Items AMQP infrastructure setup completed")
	return nil
}
