...
func CreateItemEntity(em *ecs.EntityManager, itemconfig types.ItemConfig, priceconfig PriceConfig) *ecs.Entity {
	entity := em.CreateEntity()
	entity.AddComponent(components.NewItemComponent(itemconfig, itemconfig.ItemTool))
